        ...
        <>
            <div className='grid grid-cols-12 gap-6 mt-10'>
                <div className='col-span-12 xl:col-span-8'>
                        ...
                        <div className="rounded-2xl p-8 col-span-12 lg:col-span-6 bg-cover bg-center bg-[url('/public/vissn.webp')]">
                            ...
                            <div className=' mt-16'>
                                ...
                                <div className="flex gap-5 text-sm mt-4">
                                    <div>
                                        <p className="text-gray-300 font-bold">VALID THRU</p>
                                        <p>05/24</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-300 font-bold">CVV</p>
                                        <p>09X</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='bg-gradient-to-br from-[#0B1C53] to-[#10194E] p-6 rounded-2xl mt-6'>
                        <div className='flex justify-between'>
